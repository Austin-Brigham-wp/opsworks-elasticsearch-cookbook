...
cookbook 'build-essential', '= 3.0.0', git: 'https://github.com/opscode-cookbooks/build-essential.git', tag: 'v3.0.0'
...
cookbook 'yum', '= 3.6.3', git: 'https://github.com/opscode-cookbooks/yum.git', tag: 'v3.6.3'
